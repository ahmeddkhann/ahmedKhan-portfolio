...
const GridGlobe = () => {
  ...
  const sampleArcs = [
    ...
    { order: 10, startLat: -22.9068, startLng: -43.1729, endLat: 28.6139, endLng: 77.209, arcAlt: 0.1, color: colors[Math.floor(Math.random() * colors.length)] },
    { order: 10, startLat: 51.5072, startLng: -0.1276, endLat: 1.3521, endLng: 103.8198, arcAlt: 0.5, color: colors[Math.floor(Math.random() * colors.length)] },
    { order: 10, startLat: 37.5665, startLng: 126.978, endLat: 37.7749, endLng: -122.4194, arcAlt: 0.5, color: colors[Math.floor(Math.random() * colors.length)] },
  ];
